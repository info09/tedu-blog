...
export class AdminApiPostCategoryApiClient {
     ...
     * @return OK
     */
    getAllPaging(keyword?: string | null | undefined, pageIndex?: number | undefined, pageSize?: number | undefined): Observable<PostCategoryDtoPagedResult> {
    ...
    protected processGetAllPaging(response: HttpResponseBase): Observable<PostCategoryDtoPagedResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    getAll(): Observable<PostCategoryDto[]> {
    ...
    protected processGetAll(response: HttpResponseBase): Observable<PostCategoryDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class AdminApiUserApiClient {
    ...
    changePassword(body?: ChangeMyPasswordRequest | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/admin/User/change-password-current-user";
        url_ = url_.replace(/[?&]$/, "");
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(PostInListDto.fromJS(item));
            }
        }
    }
...
export class SeriesInListDtoPagedResult implements ISeriesInListDtoPagedResult {
    ...
    readonly lastRowOnPage?: number;
    additionalData?: string | undefined;
    items?: SeriesInListDto[] | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(SeriesInListDto.fromJS(item));
            }
        }
    }
